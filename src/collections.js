...
function sceneSectionIds(scene) {
  const ids = [];
...
function linkTargetForItem(raw) {
...
function normalizeDeckDefinitions(spec) {
...
function isCollectionSpec(spec) {
...
function resolveDeckSpec(inputSpec, opts = {}) {
...
function linksForScene(scene, resolved) {
  const result = [];
